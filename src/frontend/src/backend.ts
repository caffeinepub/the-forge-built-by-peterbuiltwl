...
import type { AppInfo as _AppInfo, PricingModel as _PricingModel, StressTestMetrics as _StressTestMetrics, StripeSessionStatus as _StripeSessionStatus, SubscriptionStatus as _SubscriptionStatus, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addFutureImplementationGoal(arg0: ImplementationGoal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addFutureImplementationGoal(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addImplementationGoal(arg0: ImplementationGoal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addImplementationGoal(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getApps(): Promise<Array<AppInfo>> {
        if (this.processError) {
            try {
    ...
    async getCallerGeneratedContent(): Promise<Array<GeneratedContent>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCallerGeneratedContent();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDefaultImplementationGoals(): Promise<Array<ImplementationGoal>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDefaultImplementationGoals();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDefaultStressTestMetrics(): Promise<StressTestMetrics> {
        if (this.processError) {
            try {
                const result = await this.actor.getDefaultStressTestMetrics();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFounderProfile(): Promise<FounderProfile> {
        if (this.processError) {
            try {
    ...
    async getImplementationGoals(): Promise<Array<ImplementationGoal>> {
        if (this.processError) {
            try {
                const result = await this.actor.getImplementationGoals();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getImplementationLibrary(): Promise<ImplementationLibrary> {
        if (this.processError) {
            try {
                const result = await this.actor.getImplementationLibrary();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLastStressTestResults(): Promise<StressTestMetrics | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getLastStressTestResults();
    ...
    async getStressTestMetricsHistory(): Promise<Array<StressTestMetrics>> {
        if (this.processError) {
            try {
                const result = await this.actor.getStressTestMetricsHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeImplementationGoal(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeImplementationGoal(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async runStressTest(): Promise<StressTestMetrics> {
        if (this.processError) {
            try {
                const result = await this.actor.runStressTest();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveGeneratedContent(arg0: GeneratedContent): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveGeneratedContent(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_AppInfo_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AppInfo): AppInfo {
    return from_candid_record_n12(_uploadFile, _downloadFile, value);
}
function from_candid_PricingModel_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PricingModel): PricingModel {
...
function from_candid_opt_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_SubscriptionStatus]): SubscriptionStatus | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_StressTestMetrics]): StressTestMetrics | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        pricingModel: from_candid_PricingModel_n13(_uploadFile, _downloadFile, value.pricingModel)
    };
}
function from_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        name: value.name,
        email: value.email,
        subscriptionStatus: record_opt_to_undefined(from_candid_opt_n18(_uploadFile, _downloadFile, value.subscriptionStatus))
    };
}
...
function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_AppInfo>): Array<AppInfo> {
    return value.map((x)=>from_candid_AppInfo_n11(_uploadFile, _downloadFile, x));
}
...
function to_candid_record_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        name: value.name,
        email: value.email,
        subscriptionStatus: value.subscriptionStatus ? candid_some(value.subscriptionStatus) : candid_none()
    };
}
